...
- Node id: `hapa-living-comic`
- Repo name: `hapa-living-comic`
- Hapa system group: `apps` (Apps)
- Target assembly path: `hapa-system/apps/hapa-living-comic`
...
| `hapa-wiki-viewer` | Shares the Apps module group. |
